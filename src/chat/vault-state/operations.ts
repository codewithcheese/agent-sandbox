 ...
 *
 * The node ID is auto-generated by the TreeNode constructor.
 * During tree rebuild, the ID counter is reset so replay produces identical IDs.
 *
...
export function executeCreate(state: VaultState, op: CreateOperation): TreeNode {
  ...
  const newNode = new TreeNode(state);
