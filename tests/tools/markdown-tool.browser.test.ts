...
describe("Markdown Tool Execution", () => {
  ...
  beforeEach(() => {
    ...
    // Create a minimal chat instance for tool execution
    mockChat = { toolRequests: [] } as unknown as Chat;
...
`;
    ...
    expect(toolDef?.code).toBeUndefined();
  ...
  it("should create and execute a tool from a markdown definition with code", async () => {
    ...
    // Create the tool
    const echoTool = await createTool(mockToolDef, mockChat);
  ...
  it("should create and execute a tool from a markdown definition with import", async () => {
    ...
    // Create the tool
    const thinkTool = await createTool(mockToolDef, mockChat);
  ...
  it("should handle errors in tool execution with code", async () => {
    ...
    // Create the tool
    const errorTool = await createTool(mockToolDef, mockChat);
